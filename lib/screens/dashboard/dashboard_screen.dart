...
class _DashboardScreenState extends State<DashboardScreen> {
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              toolbarHeight: _screenSize.height * 0.06,
              automaticallyImplyLeading: false,
              leading: null,
              title: state.dashboardStatus == DashboardStatus.home ? Container(
              ...
              actions: [
                IconButton(
                  ...
                  }, icon:  state.sp != null && state.sp!.getBool("new_notification")! ? SvgPicture.asset(
                ...
                IconButton(
                  ...
                  }, icon:  Icon(Icons.account_circle_outlined,  color: Colors.black, size: _screenSize.width * 0.065,),)

              ],
            ),
            body: Stack(
              children: [
                state.dashboardStatus == DashboardStatus.home ? HomeFragment() : state.dashboardStatus == DashboardStatus.services ? ServicesFragment() :
                state.dashboardStatus == DashboardStatus.points ? PointsFragments() : state.dashboardStatus == DashboardStatus.blog ?  BlogFragment() : Container(),
                // _mainBody(context),
  ...
  _mainBody(context) {
    ...
    //           elevation: 0,
    //           backgroundColor: Style.secondaryColor,
    //           leading: Text("Γεια σου,", style: TextStyle(color: Colors.black),),
    //           actions: [
    //             IconButton(
    //               onPressed: () {
    //                 AppToast.showMessage("Θα είναι διαθέσιμο σε επόμενη εκδοση");
