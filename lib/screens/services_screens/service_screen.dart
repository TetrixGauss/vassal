              ...
              children: [ widget.category.rel_path != "" ?
                ...
                Flexible(
                  child: Container(
                    ...
                    margin: EdgeInsets.only(top: _screenSize.height * 0.01, bottom:
          ...
          children: [
            ...
            Flexible(
              child: Container(
                ...
                child: Text(
                  name,
                  style: TextStyle(color: selected ? Colors.black : Style.primaryColor, fontSize: 14),
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              height: _screenSize.width * 0.17,//_screenSize.height * 0.05,
