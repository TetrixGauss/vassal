...
abstract class sendMessageEvent implements ChatEvent {
  const factory sendMessageEvent(final String message) = _$sendMessageEvent;
...
mixin _$ChatState {
  ...
  Stream<List<ChatMessage>> get stream => throw _privateConstructorUsedError;
...
class _$chatState implements chatState {
  ...
  @override
  String toString() {
    return 'ChatState(chatStatus: $chatStatus, errorMessage: $errorMessage, messages: $messages, controller: $controller, stream: $stream)';
  }
...
abstract class chatState implements ChatState {
  const factory chatState(
      ...
      required final Stream<List<ChatMessage>> stream}) = _$chatState;
